                      ...
                      Row(
                        children: [
                          CircleAvatar(
                            ...
                            ReusableTextWidget(
                              text: authenticationController.getInitials(controller.tenantFirstName.value ?? '', controller.tenantLastName.value) ??
                                  authenticationController.getInitials(createAccountController.firstName.value , createAccountController.lastNameController.text) ?? '',
                              fontSize: 40,
